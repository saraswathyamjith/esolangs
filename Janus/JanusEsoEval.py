...
Original file is located at
    https://colab.research.google.com/drive/1kut5pd2-z9rHLgwfrQ4cSlZ-y2TeEsRJ
"""
...
def write_janus_code(task_id, code):
    ...
    # Define the filename with the correct path
...
if os.path.exists(examples_dir):
    for file_name in os.listdir(examples_dir):
        if file_name.endswith('.ja'):  # Only process .ja files
...
# Combines PDF text and examples into singular file
...
def mod_prompt(prompt):
   modified_prompt = (
        ...
        f"The documentation for Janus is provided here: '{documentation}'. "
...
for problem in problems[:30]:
    ...
    print(f"Test Result for Task {task_id}: {test_result}")  # Debugging line
