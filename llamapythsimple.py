# -*- coding: utf-8 -*-
"""LLAMApythsimple.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IdrOrDTYdTStOtZiBSTqXTQhZduYbxBf
"""
...
def mod_prompt(prompt):
   modified_prompt = (
        ...
        f"The documentation for Pyth is provided here: '{text_content[:5000]}'. "
...
for idx, problem in enumerate(problems):  # Adjust the range as needed
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            max_tokens=300  # Adjust based on expected code length
        )
